...
import {
	...
	asyncEditEvent,
	asyncEditEventDate,
	asyncPatchEvent_isDone
} from '../../../actions/event_actions';
import {
	asyncFetchSteps,
	asyncPostStep,
	asyncPatchStep_isDone,
	asyncEditStep,
	asyncDeleteStep,
	rearrangeReduxSteps,
	asyncRearrangeSteps
	...
	return (
		<div className="todo-details-comp-000 any-list-comp-container-999">
			...
			>
				...
				/>
				{stepTitle && (
					<button name="Add Step" className="any-list-comp-form-submit-btn-003" type="submit">
						Add
					</button>
				)}
			</form>

			<EventDetailsButtonsComp {...props} handleEventDelete={handleEventDelete} />
		</div>
	);
};
