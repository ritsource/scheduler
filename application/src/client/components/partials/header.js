			...
			<div className="header-000">
				<div className="header-001-left-div">
					...
					<Link to="/">
						<h2 id="application-header-brand-logo" className="my-theme-gradient-text">
							<ReactSVG src="/calendar.svg" />Schedular
						</h2>
					</Link>
				</div>
				...
				{this.props.auth ? (
					<React.Fragment>
						{this.props.appMode === 0 && (
							<div className="header-001-calendar-nav">
								...
								<p>
									{month_name_dictionary[this.props.month]}&nbsp;{this.props.year}
								</p>
							</div>
						)}
						...
						<div className="header-001-right-div">
							<div className="header-002-app-mode-div">
								<Link to="/calendar">
									<button
										name="Chnage to Calendar Mode"
										className="awesome-app-unique-btn-999"
										disabled={this.props.appMode === 0}
									>
										Calendar
									</button>
								</Link>
								<Link to="/todo">
									<button
										name="Chnage to Todo Mode"
										className="awesome-app-unique-btn-999"
										disabled={this.props.appMode === 1}
									>
										Todo
									</button>
								</Link>
					...
					<div className="header-unauth-button-row-001">
						<a className="the-hover-blue-text" href="/about">
							About
						</a>
						<a
							target="_blank"
