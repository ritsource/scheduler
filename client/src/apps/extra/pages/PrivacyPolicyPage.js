...
const PrivacyPolicyPage = () => {
	return (
		<div className="PrivacyPolicy-p-00">
			...
			<div className="PrivacyPolicy-Content-Div-01">
				<p>
					...
					<a href="mailto: ritwik.codehard@gmail.com">ritwik.codehard@gmail.com</a>
				</p>
				<h3>Log Files</h3>
				<p>
					Log Files Schedular follows a standard procedure of using log files. These files log visitors when
				...
				<p>
					...
					that are used in their respective advertisements and links that appear on Schedular, which are sent
				...
				<p>
					Note that Schedular has no access to or control over these cookies that are used by third-party
					advertisers.
				</p>

				<h3>Third Pary Privacy Policies</h3>
				<p>
					Schedular's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
				...
				<p>
					Schedular does not knowingly collect any Personal Identifiable Information from children under the
				...
				<p>
					...
					with regards to the information that they shared and/or collect in Schedular. This policy is not
