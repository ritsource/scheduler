	...
	return (
		<div className="PrivacyPolicy-p-00">
			...
			<div className="PrivacyPolicy-Content-Div-01">
				...
				<p>
					&ensp; You can choose to disable cookies through your individual browser options. To know more
				...
				<p>
					&ensp; Another part of our priority is adding protection for children while using the internet. We
				...
				<h3>Consent</h3>
				<p>
					&ensp; By using our website, you hereby consent to our Privacy Policy and agree to its Terms and
					Conditions.
				</p>
			</div>
		</div>
